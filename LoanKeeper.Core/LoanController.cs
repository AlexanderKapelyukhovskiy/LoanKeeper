				...
				new[]
					{
						...
						new MountlyPayment {Payments = new[] {new Payment {PaymentDate = new DateTime(2011, 12, 09), Interest = 268.72m, Body = 31.28m},
							new Payment {PaymentDate = new DateTime(2011, 12, 20), PayAmount = 1100.00m}}},

						//new MountlyPayment {Payments = new[] {new Payment {PaymentDate = new DateTime(2012, 01, 09), Interest = 266.32m, Body = 33.68m},
							//new Payment {PaymentDate = new DateTime(2012, 01, 12), PayAmount = 1900.00m}}},
